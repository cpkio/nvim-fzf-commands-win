...
return function(opts)
  ...
  coroutine.wrap(function ()
    local gitsrc = 'git diff --relative --name-only --no-color'
    ...
    local fzfcommand = (term.fzf_colors .. '--expect=ctrl-s,ctrl-t,ctrl-v,ctrl-r,ctrl-p --header="' .. tip .. '" --ansi --multi --prompt="GitFiles> " --delimiter="' .. utils.delim .. '" --preview=%s'):format(fn.shellescape(preview))
